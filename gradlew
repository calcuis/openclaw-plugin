...
#
#   (2) In accordance with the POSIX standard, on a blank line, a backslash
#       at the end of a line does NOT cause continuation. It is simply a literal
...
# This is reliable for both GNU and BSD readlink.
